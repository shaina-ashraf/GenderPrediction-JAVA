...
public class CreateARFF {
    ...
    void initializeARFF(){
        ...
        Attribute classAttribute = new Attribute("Class", attVals); 
    ...
    void generateArffFile(double[] features, String[] authorInfo)  throws Exception {
    ...
    void createARFF()  throws Exception {
    	
    	 BufferedWriter writer = new BufferedWriter(new FileWriter(Constants.ARFF_FILE));
