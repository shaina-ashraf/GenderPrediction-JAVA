...
float countDensity(){
    	...
    	System.out.println("Total Trigrams: "+totalTokens+" Unique Trigrams: "+fullResults.length);
    	float result=0;
    	if(totalTokens>0)
    			result=(fullResults.length/(float)totalTokens)*100;
    	 System.out.println("Trigram Density is: "+result);
 ...
 */
	...
	void collectStats(String s) {
	 ...
	 System.out.println("Number of Trigrams is: " + table.size());
 ...
 class BigramsCounts{
	...
	*/
	...
	void showFrequencyResults() {
		...
		Arrays.sort(fullResults, comp);
		System.out.println("Results sorted by Trigram count:");
		for(int i=0; i < fullResults.length; i++){
